...
Page({
    ...
    getdymaic: function (e) {
        ...
        wx.request({
            ...
            success: function (res) {
                ...
                if (data.member_id === app.globalData.userid) {
                    identity = true;
                } else {
                    identity = false;
                }
    ...
    onShareAppMessage: function (res) {
        ...
        return {
            title: '健身房小程序',
            path: '/pages/member/circle/index?id='+that.data.id+'&wid='+that.data.wid,
            success: function (res) {
                console.log(res);
            },
        }
            ...
            success: function (res) {
                ...
                qiniuUploader.upload(filePath, (res) => {
                    ...
                    wx.request({
                        ...
                        data: {
                            hash_value: app.globalData.hash_value,
                            course_dynamic_id: that.data.dynamicdata.id,
                            img_url: res.key
                        },
                        method: 'GET',
                        success: function (res) {
